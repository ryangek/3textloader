function generateHtml(textObj) {
  ...
  <svg
      ...
      y="0"
      viewBox="0 0 642 466"
      enable-background="new 0 0 642 466"
      xml:space="preserve"
      style="position: fixed; left: 0; top: 0;height: 100vh;z-index: 9999;width: 100%;background: rgba(255,255,255,.32);font-family: 'Prompt', sans-serif;"
    >
      <g>
        <text
          x="288"
          y="232"
          id="Xx"
          style="fill: ${textObj.B.colorTextFade};font-size: 100px;font-weight: bold;"
        >
        ${textObj.B.text}
        </text>
        <text
          ...
          y="232"
          id="N"
          style="fill:${textObj.A.colorText};font-size: 100px;font-weight: bold"
        >
        ${textObj.A.text}
        </text>
        <text
          ...
          y="232"
          id="P"
          style="fill: ${textObj.C.colorText};font-size: 100px;font-weight: bold;"
        >
        ${textObj.C.text}
        </text>
        <text
          ...
          y="232"
          id="X"
          style="fill: ${textObj.B.colorText};font-size: 100px;font-weight: bold;"
        >
        ${textObj.B.text}
        </text>
      </g>
          ...
          return (
            ...
            (s.render = function(a, b, c) {
              ...
              if ((o._time !== p && o._first) || c || i || l) {
                ...
                o._onUpdate &&
                  (b || (j.length && k(), o._callback('onUpdate'))),
                  h &&
                    (o._gc ||
            ...
            ha = function(a, b, c) {
              ...
              for (c = c || _(a, null); --f > -1; )
                (d -= parseFloat(aa(a, 'padding' + e[f], c, !0)) || 0),
                  (d -=
                    parseFloat(aa(a, 'border' + e[f] + 'Width', c, !0)) || 0);
              return d;
            },
            ia = function(a, b) {
                  ...
                  for (
                    ...
                    (z = ga[xa]),
                      ...
                      (c =
                        -1 !== y.indexOf('px')
                          ? parseFloat(y)
                          : ba(this.t, z, parseFloat(y), y.replace(w, '')) ||
                            0),
                      (A =
                        c !== d[z]
                          ? 2 > xa
            ...
            za(
              'transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin',
              {
                parser: function(a, b, c, d, f, h, i) {
                  ...
                  if (
                    ((C.skewType =
                      z.skewType || C.skewType || g.defaultSkewType),
                    (d._transform = C),
              ...
              a > -n
                ...
                : 0 > a &&
                  ...
                  0 === j &&
                    ...
                    (h._rawPrevTime = g = !b || a || k === a ? a : n))),
              (!h._initted || (h._startAt && h._startAt.progress())) &&
                (c = !0);
    ...
    var tl = new TimelineMax({
      ...
      function initialLoader() {
        ...
        tl.add(getDotsWaveTl())
          .add(getDotsRotateTl(), '-=0.4')
          .add(getDrawGTl(), '-=1.1')
          .add(getBackToDotsTl(), '+=1.1')
          .add(getRemoveGTl(), '-=1.5');
        tl.timeScale(1.1);
      }
      
      function getDotsWaveTl() {
        const dotsWaveTl = new TimelineMax();
        if (dots) {
          dots.forEach((el, index) => {
            const element = el;
            const dotWaveTl = new TimelineMax();
            const delay = 0.1;
            dotWaveTl
      ...
      function getDrawGTl() {
        const drawGTl = new TimelineMax();
        const $dotN = dots[0];
        const $dotX = dots[1];
        const $dotP = dots[2];
        drawGTl
          .to($dotN, 0.1, { autoAlpha: 0 }, '+=0.2')
          .to($n, 0.1, { autoAlpha: 1 }, '-=0.2')
          .to($dotX, 0.1, { autoAlpha: 0 }, '+=0.2')
          .to($xx, 0.1, { autoAlpha: 1 }, '-=0.2')
          .to($x, 0.1, { autoAlpha: 0.6 }, '-=0.2')
          .to($dotP, 0.1, { autoAlpha: 0 }, '+=0.2')
          .to($p, 0.1, { autoAlpha: 1 }, '-=0.2');
      
        return drawGTl;
      }
      
      function getRemoveGTl() {
        const removeGTl = new TimelineMax();
        removeGTl
          .to($p, 0.1, { autoAlpha: 0 }, '+=0.1')
          .to($xx, 0.1, { autoAlpha: 0 }, '+=0.05')
          .to($x, 0.1, { autoAlpha: 0 }, '+=0.05')
          .to($n, 0.1, { autoAlpha: 0 }, '+=0.1');
      ...
      function getDotsRotateTl() {
        const dotsRotateTl = new TimelineMax();
        const $dotN = dots[0];
        const $dotX = dots[1];
        const $dotP = dots[2];
        const pathN = [
        ...
        dotsRotateTl
          .to(
            $dotN,
            0.8,
            { bezier: { curviness: 1.5, values: pathN, ease: Power2.easeInOut } },
            'move'
          )
          .to(
            $dotX,
            1.2,
            {
              bezier: { curviness: 1, values: pathX, ease: Power2.easeInOut }
            },
            'move'
          )
          .to(
            $dotP,
            1.4,
            { bezier: { curviness: 1, values: pathP, ease: Power2.easeInOut } },
            'move'
          );
      ...
      function getBackToDotsTl() {
        const backToDotsTl = new TimelineMax();
        const $dotN = dots[0];
        const $dotX = dots[1];
        const $dotP = dots[2];
        const pathNBack = [
        ...
        backToDotsTl
          .to(
            ...
            {
              autoAlpha: 1,
              bezier: { curviness: 1.5, values: pathPBack, ease: Power2.easeInOut }
            },
            'move'
          )
          .to(
            ...
            {
              autoAlpha: 1,
              bezier: { curviness: 1, values: pathXBack, ease: Power2.easeInOut }
            },
            'move'
          )
          .to(
            ...
            {
              autoAlpha: 1,
              bezier: { curviness: 1, values: pathNBack, ease: Power2.easeInOut }
            },
            'move'
          );
        return backToDotsTl;
